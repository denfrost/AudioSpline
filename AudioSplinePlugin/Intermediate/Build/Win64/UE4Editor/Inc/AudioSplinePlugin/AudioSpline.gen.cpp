...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAudioSpline_Statics::NewProp_Range_MetaData[] = {
		...
		{ "Comment", "// Distance between AudioComponent and Player. The sound is Stopped when the player goes beyond the Range\n" },
		{ "ModuleRelativePath", "Public/AudioSpline.h" },
		{ "ToolTip", "Distance between AudioComponent and Player. The sound is Stopped when the player goes beyond the Range" },
	};
#endif
	...
	IMPLEMENT_CLASS(AAudioSpline, 659313608);
