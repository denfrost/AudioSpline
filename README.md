...
There are two ways of using this tool. If you want to use the basic features of the tool you can simply use the C++ Actor. Otherwise you can create a Blueprint class from the C++ Actor and add your unique logic.
